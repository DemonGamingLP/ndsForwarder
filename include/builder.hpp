...
class Builder {
    ...
    ReturnResult* buildSRL(std::string filename, bool randomTid=false, std::string customTitle="", bool force=false, bool ignoreBannerChecksum=false);
    ...
    ReturnResult* buildCIA(std::string filename, bool randomTid=false, std::string customTitle="", bool force=false, bool ignoreBannerChecksum=false);
};
